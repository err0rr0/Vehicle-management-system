...
public class Customer extends JFrame implements ActionListener {//普通用户
    public Connection con;
    public Statement state, state1, state2, state3;
    public String sql;
    public ResultSet rs, rs_user, rs_sum;

    public JLabel J_label1, J_label2, J_label3;
    public JTextField J_Text1;
    ...
    public Customer(String s) {
        ...
        J_label3 = new JLabel(s + "你好,欢迎你使用这个系统");
        J_button2 = new JButton("确定");
        J_button5 = new JButton("换车");
        J_button6 = new JButton("查看余额");
        J_button7 = new JButton("查看已租车辆");
        J_button8 = new JButton("还车");
        ...
        J_panel2.add(J_button8);


        J_panel5 = new JPanel();
        J_panel5.add(J_button1);
        J_panel5.add(J_button6);
        J_panel5.add(J_button7);
            ...
            try {
                ...
                if (rs.next() && rs_sum.next() && rs_user.next()) {
                    ...
                    if (rs.getString("是否已被租用").equals("否") && rs_user.getInt("已租用车序号") == 0) {
                        String sql1 = "update user set 账户余额='" + (rs_user.getInt("账户余额") - rs_sum.getInt("租金")) + "' where admin='" + username + "';";
                        sql = "update car set 是否已被租用='是' where 序号='" + number + "';";
                        String sql2 = "update money set profit=profit+'" + rs_sum.getInt("租金") + "';";
